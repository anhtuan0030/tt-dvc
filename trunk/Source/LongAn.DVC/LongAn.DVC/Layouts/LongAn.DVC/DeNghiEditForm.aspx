...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeNghiEditForm.aspx.cs" Inherits="LongAn.DVC.Layouts.LongAn.DVC.DeNghiEditForm" DynamicMasterPageFile="~masterurl/default.master" %>
...
Long An - Đề nghị cấp cấp phép xe quá khổ, quá tải
</asp:Content>

<asp:Content ID="PageTitleInTitleArea" ContentPlaceHolderID="PlaceHolderPageTitleInTitleArea" runat="server" >
Đề nghị cấp cấp phép xe quá khổ, quá tải
</asp:Content>
