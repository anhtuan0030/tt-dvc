...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeNghiAppPage.aspx.cs" Inherits="LongAn.DVC.Layouts.LongAn.DVC.DeNghiAppPage" DynamicMasterPageFile="~masterurl/default.master" %>
            ...
            <div class="grid_12" id="main-frame">
                ...
                <div class="mr-form">
                    <div class="panel-2" id="divThongTinTuChoi" runat="server">
                        <h2>Chuyển / Trình duyệt Hồ sơ</h2>
                        <div class="row">
                            <div class="grid_2">
                                Ghi chú / Nhận xét
                            </div>
                            <div class="grid_9">
                                <asp:Literal ID="literalNoteAppend" runat="server"></asp:Literal>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="row">
