...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DeNghiDispForm.ascx.cs" Inherits="LongAn.DVC.ControlTemplates.LongAn.DVC.DeNghiDispForm" %>
            ...
            <span id='part1'>
                ...
                <div class="grid_12" id="main-frame">
                    ...
                    <div class="mr-form">
                        ...
                        <div class="panel-1 deNghiDetail" style="display:none;">
                            <div class="bg-2 format-1">
                                <%--<div class="row">
                                    ...
                                    <div class="grid_9">
                                        <input type="text" name="kinh-gui" id="kinh-gui" />
                                    </div>
                                    <div class="grid_1">
                                    </div>
                                    <div class="clear"></div>
                        ...
                        <div id="data_div" class="bg tittle no-border-bottom deNghiDetail" style="display:none;">
                            <div class=" row_5">
                                STT
                            </div>
                            <div class=" row_45">
                        ...
                        <div id="data_div" class="deNghiDetail" style="display:none;">
                            <div class=" row_5">
                                01
                            </div>
                            <div class="row_45">
                            ...
                            <div class=" row_30">
                                ...
                                <div id="divFileUpload1" runat="server"></div>
                            </div>
                        </div>
                        <div id="data_div" class="bg-3 deNghiDetail" style="display:none;">
                            <div class=" row_5">
                                02
                            </div>
                            <div class="row_45">
                            ...
                            <div class=" row_30">
                                ...
                                <div id="divFileUpload2" runat="server"></div>
                            </div>
                        </div>
                        <div id="data_div" class="deNghiDetail" style="display:none;">
                            <div class=" row_5">
                            ...
                            <div class=" row_30">
                                ...
                                <div id="divFileUpload3" runat="server"></div>
                            </div>
                        </div>
                        <div id="data_div" class="bg-3 deNghiDetail" style="display:none;">
                            <div class=" row_5">
                            ...
                            <div class=" row_30">
                                ...
                                <div id="divFileUpload4" runat="server"></div>
                        ...
                        <div class="panel-2" id="divLoaiDuongDisp" visible="false" runat="server">
                            ...
                            <div class="row">
                                <div class="grid_2">
                                    <SharePoint:FieldLabel ID="FieldLabel1" FieldName="LoaiDuong" runat="server" />
                                </div>
                                <div class="grid_9 col-xs-2">
                            ...
                            <div class="row">
                                <div class="grid_2">
                                    <SharePoint:FieldLabel ID="FieldLabel43" FieldName="LanXeDuocChay" runat="server" />
                                </div>
                                <div class="grid_4">
                                ...
                                <div class="grid_2">
                                    <SharePoint:FieldLabel ID="FieldLabel44" FieldName="TocDoDuocChay" runat="server" />
                                </div>
                                <div class="grid_4">
                        ...
                        <div class="panel-2" id="divLoaiDuong" visible="false" runat="server">
                            ...
                            <div class="row">
                                <div class="grid_2">
                                    <SharePoint:FieldLabel ID="FieldLabel45" FieldName="LanXeDuocChay" runat="server" />
                                </div>
                                <div class="grid_3">
                                ...
                                <div class="grid_2">
                                    <SharePoint:FieldLabel ID="FieldLabel46" FieldName="TocDoDuocChay" runat="server" />
                                </div>
                                <div class="grid_3">
