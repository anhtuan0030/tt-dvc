...
{
    public partial class DeNghiTreHanUserControl : UserControl
    {
        public DeNghiTreHan WebPart { get; set; }
        ...
        private SPListItemCollection GetDeNghi()
        {
            ...
            try
            {
                LoggingServices.LogMessage("Begin GetDeNghi-TreHan");
                //And condition
                ...
                //Ngay duoc cap phep
                andConditions.Add(x => (x[Fields.NgayDuocCapPhep] == null));
                //Ngay hen tra
                if (WebPart.Option == DeNghiTreHanOption.CommingLate)
                {
                    //Sap tre han
