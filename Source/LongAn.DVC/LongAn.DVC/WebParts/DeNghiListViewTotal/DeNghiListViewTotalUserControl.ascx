...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DeNghiListViewTotalUserControl.ascx.cs" Inherits="LongAn.DVC.WebParts.DeNghiListViewTotal.DeNghiListViewTotalUserControl" %>
