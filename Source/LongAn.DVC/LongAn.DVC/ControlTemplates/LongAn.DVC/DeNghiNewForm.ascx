...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DeNghiNewForm.ascx.cs" Inherits="LongAn.DVC.ControlTemplates.LongAn.DVC.DeNghiNewForm" %>
            ...
            <span id='part1'>
                ...
                <div class="grid_12" id="main-frame">
                    ...
                    <div class="mr-form">
                        ...
                        <div id="data_div" class="row_validate">
                            <div class="row_5">
                                01
                            </div>
                            <div class="row_45">
                        ...
                        <div id="data_div" class="bg-3 row_validate">
                            <div class="row_5">
                                02
                            </div>
                            <div class="row_45">
                        ...
                        <div style="display:none;">
                            ...
                            <asp:HiddenField ID="hdfHiddenFag" runat="server" />
                        </div>
