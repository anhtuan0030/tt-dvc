...
{
    public partial class DeNghiEditForm : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                hplDanhMucTuyenDuong.NavigateUrl = (SPContext.Current.Web.ServerRelativeUrl + Constants.DanhMucTuyenDuong).Replace("//", "/");
