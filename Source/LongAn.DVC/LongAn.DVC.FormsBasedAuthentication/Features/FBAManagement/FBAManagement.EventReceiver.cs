...
namespace LongAn.DVC.FormsBasedAuthentication.Features.FBAManagement
{
    /// <summary>
        ...
        public void ActivateMembershipReviewList(SPFeatureReceiverProperties properties)
        {
            ...
            try
            {
                ...
                if (web != null)
                {
                    ...
                    list.EventReceivers.Add(SPEventReceiverType.ItemUpdated, Assembly.GetExecutingAssembly().FullName, "LongAn.DVC.FormsBasedAuthentication.MembershipReviewHandler");
                    
                    //list.EventReceivers.Add(SPEventReceiverType.ItemAdded, Assembly.GetExecutingAssembly().FullName, "LongAn.DVC.FormsBasedAuthentication.MembershipReviewHandler");
